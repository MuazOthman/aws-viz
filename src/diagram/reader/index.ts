...
function readDiagramFile(filePath: string): ParsedFile {
...
function readComponent(vertex: unknown): Component {
...
function readPage(diagram: Diagram, app: Application): void {
...
export function readDiagram(filePath: string): Application {
  const fileContents = readDiagramFile(filePath);
